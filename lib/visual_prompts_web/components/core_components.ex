defmodule VisualPromptsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VisualPromptsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VisualPromptsWeb.Gettext, "errors", msg, opts)
    end
  end
